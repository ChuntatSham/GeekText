...
class CreditCardForm(forms.ModelForm):
    ...
    # def clean_expiration_month(self, *args, **kwargs):
    #     expiration_month = self.cleaned_data.get("expiration_month")
    #     expiration_year = self.cleaned_data.get("expiration_year")
    #     month = datetime.today()
    #     if expiration_year <= month.year and expiration_month < month.month:
    #         raise forms.ValidationError("This is not a valid expiration date")
